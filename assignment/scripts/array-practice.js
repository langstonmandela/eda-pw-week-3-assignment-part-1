...
let favoriteFoods = ['sushi', 'chimichanga', 'hot chicken sammy', 'porketa bahn mi'];
console.log('My Favorite foods are as follows: ', favoriteFoods);

// Array.length: A property that tells you how many items are in a given array.
console.log( 'Length of favorite foods array ', favoriteFoods.length );
...
console.log(' So far I am displaying, ' + numberOfFoods + ' of my favorite foods! ')
...
console.log('The last animal in this array is:', lastAnimal);
...
let dessert = 'Tiramasu';
favoriteFoods.push(dessert)
console.log ( 'Added some dessert to my favorite foods! ', favoriteFoods )
...
console.log ( ' Updated my favorite foods array with a classic french dish! ', favoriteFoods )
...
console.log('Colors array after removal:', colors);
...
gems[1] = 'Tourmaline';
console.log('Updated Citrine to Tourmaline:', gems[1])


// 5.b (STRETCH) TODO: Sort your gems array in reverse alphabetical order.
//     Please console.log the sorted array.
gems.sort().reverse();
console.log('Gems sorted in reverse alphabetical order:', gems);
